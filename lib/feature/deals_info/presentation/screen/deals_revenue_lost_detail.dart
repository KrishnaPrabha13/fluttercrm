...
class RevenueLostThisMonth extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return RevenueLostThisMonthState();
  }
}

class RevenueLostThisMonthState extends State<RevenueLostThisMonth> {
  ...
  void initState() {
    dealsTabIndex = 5;
    (widget.selectIndex != null) ? widget.selectIndex : widget.selectIndex = 5;
    super.initState();
  }
    ...
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder<List<DealsDataModel>>(
          future: _firebaseDealsServices.getRevenueLostThisMonth(
