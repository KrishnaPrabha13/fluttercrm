...
class RevenueThisMonth extends StatefulWidget {
  RevenueThisMonth(
      {Key? key, this.selectIndex, this.hideappbar, this.getAccess})
      : super(key: key);
  ...
  State<StatefulWidget> createState() {
    ...
    return RevenueThisMonthState();
  }
}

class RevenueThisMonthState extends State<RevenueThisMonth> {
  ...
  @override
  void initState() {
    print('revenue month41 ${widget.selectIndex}');
    dealsTabIndex = 4;
    (widget.selectIndex != null) ? widget.selectIndex : widget.selectIndex = 4;
    super.initState();
  }
    ...
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder<List<DealsDataModel>>(
          future: _firebaseDealsServices.getRevenueThisMonth(
