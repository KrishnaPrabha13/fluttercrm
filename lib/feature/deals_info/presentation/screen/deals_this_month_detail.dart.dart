...
class DealsThisMonthDetail extends StatefulWidget {
  DealsThisMonthDetail(
      {Key? key, dealsTabIndex, this.hideappbar, this.getAccess})
      : super(key: key);
  ...
  State<StatefulWidget> createState() {
    ...
    return DealsThisMonthDetailState();
  }
}

class DealsThisMonthDetailState extends State<DealsThisMonthDetail> {
  ...
  void initState() {
    ...
    dealsTabIndex = 2;
    print('dealsTabIndex ${dealsTabIndex}');
    //print('dealsTabIndex selectIndex ${widget.selectIndex}');
    //(widget.selectIndex != null) ? widget.selectIndex : widget.selectIndex = 2;
    super.initState();
  }
    ...
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder<List<DealsDataModel>>(
          future:
              _firebaseDealsServices.getMonthlyDeals(context, widget.getAccess),
