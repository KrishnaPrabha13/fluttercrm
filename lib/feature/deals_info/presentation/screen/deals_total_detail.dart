...
class TotalDealsDetailPage extends StatefulWidget {
  ...
  String? getAccess;
  @override
  State<TotalDealsDetailPage> createState() => _TotalDealsDetailPageState();
}

class _TotalDealsDetailPageState extends State<TotalDealsDetailPage> {
  ...
  void initState() {
    ...
    // (widget.selectIndex != null) ? widget.selectIndex : widget.selectIndex = 1;
    super.initState();
  }
