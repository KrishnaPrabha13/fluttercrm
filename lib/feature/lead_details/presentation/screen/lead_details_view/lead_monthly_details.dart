...
class LeadMonthlyDetails extends StatefulWidget {
  ...
  LeadMonthlyDetails(
      ...
      : super(key: key);
  @override
  State<LeadMonthlyDetails> createState() => LeadMonthlyDetailsState();
}

class LeadMonthlyDetailsState extends State<LeadMonthlyDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<CrmLeadModel>>(
        future: _firebaseLeadServices.getMonthlyLeads(
