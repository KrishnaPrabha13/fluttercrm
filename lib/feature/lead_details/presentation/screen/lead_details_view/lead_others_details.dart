...
class LeadOthersDetails extends StatefulWidget {
  ...
  LeadOthersDetails(
      ...
      : super(key: key);
  @override
  State<LeadOthersDetails> createState() => LeadOthersDetailsState();
}

class LeadOthersDetailsState extends State<LeadOthersDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<CrmLeadModel>>(
        future: _firebaseLeadServices.getOthersLeads(
