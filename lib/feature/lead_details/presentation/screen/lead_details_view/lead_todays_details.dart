...
class LeadTodaysDetails extends StatefulWidget {
  ...
  LeadTodaysDetails(
      ...
      : super(key: key);
  @override
  State<LeadTodaysDetails> createState() => LeadTodaysDetailsState();
}

class LeadTodaysDetailsState extends State<LeadTodaysDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<CrmLeadModel>>(
        future: _firebaseLeadServices.getTodayLeads(
