...
import 'package:crm_dashboard/shared/common_widgets/common_widgets.dart';
...
class LeadTotalDetails extends StatefulWidget {
  ...
  LeadTotalDetails(
      ...
      : super(key: key);
  @override
  State<LeadTotalDetails> createState() => LeadTotalDetailsState();
}

class LeadTotalDetailsState extends State<LeadTotalDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<CrmLeadModel>>(
        future: _firebaseLeadServices.getTotalLeads(
                                    ...
                                    content: SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          //   children: [
                                          //     // Text(
                                          //     //   '${AppString.leadOwner}  : ${row.getCells()[0].value.toString()}',
                                          //     //   style: TextStyle(
                                          //     //       color: black,
                                          //     //       fontFamily:
                                          //     //           FontName.montserrat,
                                          ...
                                          // ),
                                          // Text(
                                          //   '${AppString.company}  : ${row.getCells()[1].value.toString()}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          ...
                                          // Text(
                                          //   '${AppString.businessunit}  : ${row.getCells()[2].value.toString()}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          //       fontSize: (Responsive.isDesktop(
                                          ...
                                          // ),
                                          // Text(
                                          //   '${AppString.leadbysource}  : ${row.getCells()[3].value.toString()}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          //       fontSize: (Responsive.isDesktop(
                                          ...
                                          // ),
                                          // Text(
                                          //   '${AppString.probability}  : ${"${row.getCells()[4].value}%"}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          //       fontSize: (Responsive.isDesktop(
                                          ...
                                          // ),
                                          // Text(
                                          //   '${AppString.datetime}  : ${getCTPDateTime(row.getCells()[5].value.toString())!}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          //       fontSize: (Responsive.isDesktop(
                                          ...
                                          // ),
                                          // Text(
                                          //   '${AppString.country}  : ${row.getCells()[6].value.toString()}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          //       fontSize: (Responsive.isDesktop(
                                          ...
                                          // ),
                                          // Text(
                                          //   '${AppString.leadlookingfor}  : ${row.getCells()[7].value.toString()}',
                                          //   style: TextStyle(
                                          //       color: black,
                                          //       fontFamily: FontName.montserrat,
                                          //       fontSize: (Responsive.isDesktop(
